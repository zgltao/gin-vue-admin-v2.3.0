...
func Casbin() *casbin.Enforcer {
	...
	case "postgres":
		...
		a, _ := gormadapter.NewAdapter(global.GVA_CONFIG.System.DbType, "host= "+admin.Host+" port="+admin.Port+" user="+admin.Username+" dbname="+admin.Dbname+" password="+admin.Password+" "+admin.Config, true)
		e, _ := casbin.NewEnforcer(global.GVA_CONFIG.Casbin.ModelPath, a)
		e.AddFunction("ParamsMatch", ParamsMatchFunc)
		_ = e.LoadPolicy()
		return e
